...
def temp_pdf():
    ...
    doc = fitz.open()
    page = doc.new_page()
    page.insert_text((50, 50), "This is a local Python resume for John Doe, expert in PyTorch and SQLite.")
    doc.save(pdf_path)
    doc.close()
...
def test_db_indexing_and_retrieval(temp_db, temp_pdf):
    ...
    extracted_text = "This is a local Python resume for John Doe, expert in PyTorch and SQLite."
...
def test_db_search(temp_db, temp_pdf):
    ...
    doc_id_1 = temp_db.index_document(temp_pdf, "Python dev text", metadata_1)
    ...
    doc_id_2 = temp_db.index_document(temp_file_2, "Invoice for host services", metadata_2)
